...
const templateOrder = (name, id, date, products, address, cep, email, phone, cpf, paymentMode, subtotal, total, deliveryRate) => {
    return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <div class="main-container">
            <div class="box">
                ...
                <div class="content-container">
                    ...
                    <p class="subtitle2">Obrigada por comprar com a ArtigosDecor!</p>
