    ...
    <section className='flex flex-col border border-y-0 overflow-x-hidden py-4 gap-y-2'>
        <div className='flex justify-between items-center px-5'>
            <div className='flex flex-col w-fit gap-0.5'>
                ...
                <div className='w-11/12 h-1.5 bg-gray-800 rounded-full'></div>
            </div>
            <Link className ='text-gray-800 text-sm font-medium'>Ver todos</Link>
        </div>
        
        <div className='flex gap-3.5 overflow-x-auto scrollbar-hide px-5 pb-0.5'>
