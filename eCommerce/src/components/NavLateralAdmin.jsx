...
export default function NavLateralAdmin({selected, setSelected, menuMobile, setMenuMobile, animate, setAnimate}) {
  ...
  return (
    <section className={`${menuMobile ? 'flex flex-col' : 'hidden'} ${handleClass()} absolute -top-20 right-0 md:static md:flex flex-col border  md:py-8 md:pl-10 w-72 gap-y-6 h-full bg-white z-20`}>
