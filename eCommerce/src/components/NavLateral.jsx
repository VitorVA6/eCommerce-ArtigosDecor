            ...
            {categorias.map( categoria => (
              <Link key={categoria} to={`/category/${categoria}`} className='flex flex-col items-center gap-y-3'>
                <div className='p-1.5 bg-white rounded-[60px]'>
                  <div className='w-32 h-32 md:w-40 md:h-40 bg-cover bg-center rounded-full' style={{backgroundImage:`url(https://s2.glbimg.com/8WjMhMAzFD0a8QAhKrmR9zUx_RI=/smart/e.glbimg.com/og/ed/f/original/2021/04/06/livros-saude-mental.jpg)`}}/>
                </div>
