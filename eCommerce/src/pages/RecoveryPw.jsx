...
export default function RecoveryPw() {
  ...
  return (
    <section className='flex flex-col justify-center items-center w-screen h-screen bg-blue-400'>
        <div className='flex flex-col justify-center items-center w-1/2 gap-5 bg-white px-40 pt-10 pb-16 rounded-3xl'>
            {
                verified ? 
                <>
                    <RiLockPasswordFill className='w-36 h-36 text-blue-500'/>
                ...
                :
                <>
                    <MdEmail className='w-36 h-36 text-blue-500'/>
                    ...
                    />
                    <button className='bg-blue-500 text-white w-full rounded-lg py-3 text-sm font-medium'>Enviar</button>
                </>
            }
        </div>
