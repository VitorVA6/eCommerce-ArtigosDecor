...
export default function Cart() {
  ...
  return (
    <section className='lg:px-16'>
        <h2 className='px-6 pb-1 pt-4 text-lg font-medium lg:text-2xl lg:py-8 text-gray-700'>Meu carrinho</h2>
        <div className='flex flex-col lg:gap-8 justify-between lg:flex-row px-6'>
            <div className='flex flex-col w-full gap-y-0 lg:gap-y-6 border-b-4 border-gray-200 lg:border-none'>
                <div className='border-b-4 lg:border border-gray-200 lg:px-8 lg:rounded-lg w-full h-fit'>
                            ...
                            <div className='flex flex-col lg:flex-row justify-between items-center w-full gap-2'>
                                <div className='flex gap-3'>
                                    ...
                                    <div className='flex justify-center flex-col'>    
                                        ...
                                        <button className='text-xs bg-gray-300 py-1 px-2.5 rounded-md font-medium border border-gray-400 block lg:hidden w-fit mt-0.5'>Excluir</button>
                                    </div>
                                </div>
                                <svg onClick={() => removeCarrinho(elemento._id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hidden lg:block w-6 h-6 lg:w-5 lg:h-5 text-gray-400 cursor-pointer">
                ...
                <div className='flex flex-col w-full lg:border border-gray-200 py-5 lg:px-8 rounded-lg gap-y-2'>
            ...
            <div className='lg:border border-gray-200 rounded-lg lg:px-7 py-6 w-full h-fit lg:w-5/12'>
