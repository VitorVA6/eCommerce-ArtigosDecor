        ...
        <div className='flex gap-8 justify-between'>
            <div className='border border-gray-200 py-2 px-8 rounded-lg w-full h-fit'>
                { carrinho.length > 0 ? carrinho.map( (elemento, index) => (
                    <div key={elemento?._id} className={`flex py-5 h-32 items-center gap-4 ${index<(carrinho.length-1)?'border-b border-gray-300':''}`}>
                        ...
                        <div className='flex justify-between items-center w-full'>
                            ...
                            <svg onClick={() => removeCarrinho(elemento._id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-400 cursor-pointer">
