...
export default function Cart() {
  ...
  return (
    <section>
        <h2 className='text-lg mb-4 mt-5 font-medium lg:mt-10 lg:text-3xl'>Sacola de compras</h2>
        <div className='flex flex-col lg:gap-8 justify-between lg:flex-row'>
            <div className='flex flex-col w-full gap-y-0 lg:gap-y-6 border-b-4 border-gray-200 lg:border-none'>
                <div className='border-b-4 lg:border border-gray-200 py-3 px-2 lg:px-8 lg:rounded-lg w-full h-fit'>
                            ...
                            <div className='flex justify-between items-center w-full'>
                                <div className='flex gap-3'>
                                    ...
                                    <div className='flex justify-center flex-col'>    
                                        <p>{elemento?.title}</p>
                                        <p className='font-medium text-sm'>{elemento?.preco.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</p>
                                    </div>
                                </div>
                                <svg onClick={() => removeCarrinho(elemento._id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 lg:w-5 lg:h-5 text-gray-400 cursor-pointer">
                ...
                <div className='flex flex-col w-full lg:border border-gray-200 py-5 px-2 lg:px-8 rounded-lg gap-y-2'>
                    <h1 className='hidden lg:block font-medium'>Cálculo do frete</h1>
                    <p className='font-medium'>Insira o seu CEP</p>
                    <div className='w-full flex justify-between mb-4 gap-x-2 lg:w-2/3'>
                        ...
                        <button className='bg-black text-white py-2 px-4 rounded-lg'>Calcular</button>
                </div>
                </div>
            </div>
            <div className='lg:border border-gray-200 rounded-lg px-2 lg:px-7 py-6 w-full h-fit lg:w-5/12'>
