...
export default function ForgotPassword() {
    ...
    return (
        ...
        <SEO
            ...
            description='Recupere sua senha por enviar um e-mail de verificação para o endereço informado'
            url = 'https://artigosdecor.render.com/users/forgot-password'
            canonical = 'https://artigosdecor.render.com/users/forgot-password'
            keywords = 'senha, recuperar senha, esqueci a senha'
        />
